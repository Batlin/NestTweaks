...
def main(api_endpoint, credentials,
    ...
    with TextAssistant(lang, device_model_id, device_id, display,
        ...
        query = 'Whats the thermostat mode'
        action = 'Set thermostat to heat mode'
        response_text, response_html = assistant.assist(text_query=query)

        if b' heat' in response_html:
            click.echo('Heat mode')
        elif b' eco' in response_html:
            click.echo('Eco mode')
            response_text, response_html = assistant.assist(text_query=action)
        elif b' turned off' in response_html:
            click.echo('Off')
        else:
            click.echo('Unknown')
